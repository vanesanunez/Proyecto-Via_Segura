...
export async function getTrustedContacts(userId) {
  ...
  if (errRels) {
    console.error('[contacts.js getTrustedContacts] Error al traer relaciones:', errRels);
    throw errRels;
  }
  ...
  if (errProfiles) {
    console.error('[contacts.js getTrustedContacts] Error al traer perfiles:', errProfiles);
    throw errProfiles;
  }
...
export async function addTrustedContact(userId, contactId) {
  ...
  if (error) {
    console.error('[contacts.js addTrustedContact] Error al insertar relación:', error);
    throw error;
  }
  return data;
}
...
export async function removeTrustedContact(relationId) {
  ...
  if (error) {
    console.error('[contacts.js removeTrustedContact] Error al eliminar relación:', error);
    throw error;
  }
}
