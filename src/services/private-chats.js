...
async function fetchPrivateChat(sender_id, receiver_id) {
  ...
  if (error) {
    console.error(
      "[private-chats.js fetchPrivateChat] Error al traer el chat privado: ",
      error
    );
    throw error;
  }
...
async function createPrivateChat(sender_id, receiver_id) {
  ...
  if (error) {
    console.error(
      "[private-chats.js createPrivateChat] Error al crear el chat privado: ",
      error
    );
    throw error;
  }
...
export async function sendPrivateChatMessage(sender_id, receiver_id, body) {
  ...
  if (error) {
    console.error(
      "[private-chats.js sendPrivateChatMessage] Error al enviar el mensaje de chat privado: ",
      error
    );
    throw error;
  }
 ...
 * @param {() => {}} callback
 */
export async function subscribeToPrivateChatNewMessages(
  sender_id,
  receiver_id,
  callback
) {
...
export async function getLastPrivateChatMessages(sender_id, receiver_id) {
  ...
  if (error) {
    console.error(
      "[private-chats.js getLastPrivateChatMessages] Error al traer los últimos mensajes del chat privado: ",
      error
    );
    throw error;
  }
