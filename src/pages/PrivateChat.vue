...
<template>
    <template v-if="!loadingUser">
        <h2 class="m-4">Chat privado con {{ userChat.name }}</h2>
        ...
        <section>
            ...
            <form @submit.prevent="sendMessage" class="flex gap-2 items-center">
                ...
                <button type="submit" class="p-2 bg-blue-600 rounded-full hover:bg-blue-500 active:bg-blue-700 text-white flex items-center justify-center">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-9.193-5.39a1 1 0 00-1.447.894v10.756a1 1 0 001.447.894l9.193-5.39a1 1 0 000-1.768z" />
                    </svg>
                </button>
            </form>
        </section>
