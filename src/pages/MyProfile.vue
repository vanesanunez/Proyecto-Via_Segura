...
<template>
  <div
    class="flex flex-col min-h-full bg-gray-50 font-['Inter'] pb-24"
    style="color: #2a2a2a"
  >
    <!-- HEADER -->
    <div
      class="mt-4 flex items-center gap-3 px-4 py-3 border-b border-gray-100"
    >
      <button
        @click="$router.back()"
    ...
    <div v-if="!loading">
      ...
      <div class="px-4 pt-5 pb-4">
        <div
          ...
          style="background: linear-gradient(135deg, #3082e3 0%, #1a5fbf 100%)"
        >
          ...
          >
            <div
              class="py-3.5 flex flex-col items-center gap-0.5 border-r"
              style="border-color: rgba(255, 255, 255, 0.15)"
            >
      ...
      <div class="px-4 pb-4">
        ...
        >
          <div
            class="flex items-center gap-3 px-4 py-3.5 border-b border-gray-50"
          >
            <div
      ...
      <div class="px-4 pb-4">
        ...
        <div
          v-if="trustedContactsError"
          class="rounded-xl px-4 py-3 text-sm mb-3"
        ...
        <div v-if="trustedContactsLoading" class="flex justify-center py-6">
          <div
            ...
            style="border-color: #3082e3; border-top-color: transparent"
          ></div>
        </div>
      ...
      <div class="px-4 pb-4">
        ...
        >
          ...
          <div v-else>
            ...
            <!-- Puntos + dibujo -->
            <div
              class="flex items-start justify-between gap-3 pb-4 border-b border-[#e8edf5]"
            >
              <div class="flex items-start gap-3 min-w-0">
                <div
                  class="w-14 h-14 rounded-full bg-[#eaf1ff] flex items-center justify-center shrink-0"
                >
                ...
                <div class="min-w-0">
                  <p
                    class="text-[36px] leading-none font-extrabold text-[#0f172a]"
                  >
                    {{ gamificationLoading ? "..." : totalPoints }}
                  </p>
                  <p
                    class="text-[16px] leading-none font-bold text-[#3082e3] mt-1"
                  >
                    puntos
                  </p>
                  <p
                    class="text-[12px] leading-5 text-slate-500 mt-2 max-w-[145px]"
                  >
            ...
            <div class="grid grid-cols-2 gap-3 mt-4">
              <div
                class="rounded-2xl bg-[#f6f8fc] px-3 py-3 flex items-center gap-3"
              >
                <div
                  class="w-12 h-12 rounded-full bg-[#dfeaff] flex items-center justify-center shrink-0"
                >
                  <div
                    class="w-8 h-8 rounded-full bg-[#1f7bf2] flex items-center justify-center"
                  >
              ...
              >
                <div
                  class="w-12 h-12 rounded-full bg-[#ffe3dd] flex items-center justify-center shrink-0"
                >
                  <div
                    class="w-8 h-8 rounded-full bg-[#ff7f66] flex items-center justify-center"
                  >
            ...
            <!-- Insignia -->
            <div
              class="mt-4 rounded-2xl bg-[#eef4ff] border border-[#dbe7fb] px-3 py-3 flex items-center gap-3"
            >
              <div
