...
<template>
  <section class="min-h-screen bg-white px-4 pt-8 pb-24">
    <div class="mx-auto w-full max-w-[390px]">
      <div class="rounded-[30px] bg-[#eef4ff] p-6 text-center shadow-[0_18px_40px_rgba(15,23,42,0.12)]">
        <div
          class="mx-auto flex h-20 w-20 items-center justify-center rounded-3xl bg-white text-[#3082e3] shadow-[0_14px_28px_rgba(48,130,227,0.18)]">
        ...
        <span class="mt-5 inline-flex rounded-full bg-white px-3 py-1 text-[11px] font-semibold text-[#3082e3]">
          Reporte enviado
        </span>
        ...
        <div class="mt-5 rounded-[22px] bg-white px-4 py-4 text-left shadow-[0_10px_24px_rgba(148,163,184,0.10)]">
          <div class="flex items-center gap-3">
            <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#fff1ed] text-[#f2826d]">
        ...
        <div class="mt-5 text-left">
          ...
          <div class="h-2 overflow-hidden rounded-full bg-white/80">
            <div class="h-full rounded-full bg-[#3082e3] transition-all duration-500"
              :style="{ width: loadingGamification ? '0%' : progressPercent }"></div>
          </div>
