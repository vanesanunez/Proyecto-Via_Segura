...
<template>
  <div class="min-h-screen overflow-hidden bg-[#f7f9f6]">
    ...
    <!-- HERO DE BIENVENIDA -->
    <section class="relative min-h-[370px] overflow-hidden bg-[#3082e3] text-white">
      <!-- Imagen como fondo del hero -->
      <img src="/hero-login.png" alt="imagen de edificios, mapa y ubicación" aria-hidden="true"
    ...
    <section class="relative z-20 -mt-12 px-4 pb-10">
      <div
        ...
        <form class="mt-7 space-y-5" action="#" @submit.prevent="handleSubmit">
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input id="email" v-model="user.email" type="email" autocomplete="email" required
          ...
          <div>
            ...
            <div class="relative">
              ...
              <input id="password" v-model="user.password" :type="showPassword ? 'text' : 'password'"
                autocomplete="current-password" required placeholder="Ingresá tu contraseña"
        ...
        <p class="text-center text-sm text-slate-600">
          ...
          <RouterLink to="/crear-cuenta" class="ml-1 font-semibold text-[#3082e3] transition hover:text-[#085baf]">
            Crear cuenta
          </RouterLink>
        </p>
      </div>
