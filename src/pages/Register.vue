...
<template>
    ...
    <form action="#" @submit.prevent="handleSubmit">
        ...
        <div class="mb-4">
            ...
            <input type="name" id="name" class="w-full p-2 border border-blue-300 rounded" v-model="user.name">
        </div>
        <div class="mb-4">
            <label for="lastname" class="mb-2">Apellido</label>
            <input type="lastname" id="lastname" class="w-full p-2 border border-blue-300 rounded"
                v-model="user.lastname">
        </div>
        <div class="mb-4">
            <label for="lastname" class="mb-2">DNI</label>
            <input type="dni" id="dni" class="w-full p-2 border border-blue-300 rounded" v-model="user.dni">
        </div>
        <div class="mb-4">
