  ...
  <section class="min-h-dvh overflow-x-hidden bg-[#F7F9F6] px-4 pb-12 pt-5">
    <div class="mx-auto w-full max-w-5xl">
      ...
      <header
        ...
        <div class="flex min-w-0 items-start justify-between gap-3">
          <div class="min-w-0 flex-1">
            ...
            <h1 class="mt-4 wrap-break-word text-[26px] font-bold leading-tight text-slate-900 sm:text-[34px]">
      ...
      <div v-if="successMessage"
        ...
        <span class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white font-bold">
          ✓
        </span>
      ...
      <div v-if="loading"
        ...
        <div class="flex items-center gap-3">
          <div class="h-6 w-6 animate-spin rounded-full border-2 border-[#D6E8FB] border-t-[#3082E3]"></div>
      ...
      <div v-else>
        ...
        <div class="w-full min-w-0 space-y-4 overflow-hidden md:hidden">
          <article v-for="user in paginatedUsers" :key="user.id"
            ...
            <div class="mt-4 grid grid-cols-2 gap-3">
              <div class="rounded-2xl border border-[#E6EDF7] bg-[#F9FBFD] px-3 py-3">
            ...
            <!-- Cambio de rol -->
            <div class="mt-4 rounded-[18px] border border-[#D6E8FB] bg-[#EEF4FF] p-4">
              <div class="flex items-center gap-2">
                <ShieldCheckIcon class="h-5 w-5 text-[#3082E3]" />

                <label :for="`role-${user.id}`" class="text-sm font-semibold text-slate-800">
              ...
              <div class="relative mt-3">
                <select :id="`role-${user.id}`" :value="user.role" @change="handleRoleChange(user.id, $event)"
              ...
              <p v-if="updatingUserId === user.id" class="mt-2 text-xs font-medium text-[#3082E3]">
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full border-collapse">
              <thead class="bg-[#EEF4FF]">
                <tr class="text-left">
                  <th class="px-4 py-4 text-xs font-bold uppercase tracking-wide text-slate-600">
                    Usuario
                  </th>
                ...
                <tr v-for="user in paginatedUsers" :key="user.id"
                  ...
                  <td class="px-4 py-4">
                    <div class="relative min-w-[170px]">
                      <select :value="user.role" @change="handleRoleChange(user.id, $event)"
                        :disabled="updatingUserId === user.id"
        ...
        <nav v-if="totalPages > 1" class="mt-6 flex items-center justify-center gap-2"
          ...
          <button v-for="pageNumber in totalPages" :key="pageNumber" type="button" @click="goTo(pageNumber)"
