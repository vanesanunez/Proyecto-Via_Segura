...
<template>
  ...
  <div v-if="!finished" class="max-w-3xl mx-auto p-4 relative">
    ...
    <div class="mt-4">
      <button @click="stopFollowingAndExit"
  ...
  <section v-else class="min-h-screen bg-white px-4 pt-8 pb-24">
    <div class="mx-auto w-full max-w-[390px]">
      <div class="rounded-[30px] p-6 text-center shadow-[0_18px_40px_rgba(15,23,42,0.12)]"
        ...
        <div
          ...
          <svg v-if="finished.arrived" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
            stroke-width="2" stroke="currentColor" class="h-10 w-10">
            <path stroke-linecap="round" stroke-linejoin="round"
        ...
        <span class="mt-5 inline-flex rounded-full bg-white px-3 py-1 text-[11px] font-semibold"
        ...
        <div class="mt-6">
          <button type="button" @click="goHomeAfterFinish"
