      ...
      <div class="px-4 flex flex-col gap-3">
        ...
        <ul v-if="sugerencias.length" class="border border-gray-100 rounded-xl overflow-hidden shadow-md">
          ...
          >
            ...
            <span class="text-xs leading-relaxed  min-w-0" style="color:#2a2a2a; word-break: break-word;">{{ s.display_name }}</span>
          </li>
        </ul>
    ...
    <div v-if="ubicacionUsuario" class="flex-1 flex flex-col overflow-hidden">
      ...
      <div class="px-4 py-2.5 border-b border-gray-100 overflow-hidden" style="background:#f9fafb;">
        <div class="flex items-start gap-2 w-full overflow-hidden">
          ...
          <span
            ...
            style="color:#2a2a2a; word-break: break-word; overflow-wrap: anywhere;"
          >{{ direccionInput }}</span>
        </div>
        <button
          @click="nuevaBusqueda"
      ...
      <div class="flex-1 overflow-y-auto overflow-x-hidden">
        ...
        >
          ...
          <!-- Chevron -->
          <svg
            xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 shrink-0" fill="none" viewBox="0 0 24 24"
